  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl px-2">
      <motion.div
        ...
        className="glass rounded-2xl md:rounded-full px-4 md:px-8 py-3 md:py-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl transition-all border border-white/20 dark:border-white/10 group relative overflow-hidden"
      >
