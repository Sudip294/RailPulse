  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl px-2">
      <motion.div
        ...
        className="backdrop-blur-[12px] bg-white/70 dark:bg-slate-900/60 rounded-2xl md:rounded-full px-4 md:px-8 py-3 md:py-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] transition-all border border-white/20 dark:border-white/10 group relative overflow-hidden"
      >
